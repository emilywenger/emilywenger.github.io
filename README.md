...
- Edit things in layouts if you want to customize, say, the publications.md page.

SIMPLE START: to run type "bundle exec jekyll serve --livereload" to run this locally. 


### CURRENT TODO

[] Update the layout for publications so that you can denote the title, author, conference, etc.
[] Add all current work.
[] Update your profile pic.
[] Change site title (it's an image)
[] Add your own favicon
[] Add a "news" section (and create a nifty layout for that too)
[] Hook up to your github.io and then also attach to your Ghandi domain.
[] Forward to this site from your UChicago site.
[] Add other fun things??? 


[X] Figure out if you can get rid of "Powered by Bay"
